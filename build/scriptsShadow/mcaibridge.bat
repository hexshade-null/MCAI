...
set CLASSPATH=%APP_HOME%\lib\mcaibridge-1.0.0-all.jar

@rem Execute mcaibridge
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MCAIBRIDGE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MCAIBRIDGE_EXIT_CONSOLE%" exit 1
exit /b 1
